<div class="layout">
    ...
    <div class="content">
        <div class="wrapper main-content" id="bol-section" style="display: flex;"><?php include 'partials/bol_uploader.php'; ?></div>
        <div class="wrapper main-content" id="users-section" style="display: none;"><?php include 'partials/users.php'; ?></div>
    </div>
</div>
